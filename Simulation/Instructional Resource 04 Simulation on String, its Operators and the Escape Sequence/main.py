...
print("u_text[-1] =", u_text[-1])
print("u_text[-2] =", u_text[-2])
print("u_text[-5] =", u_text[-5])
...
print(a[2])
print(b[0:3])
print("Is r in World?", ('r' in b))
print("Is k NOT IN Hello?", ('k' not in a))
...
print(f"Is 'x' in Sliced String? {'x' in result}")
print(f"Is 'a' in Sliced String? {'a' in result}")
print(f"Is 'b' in Sliced String? {'b' in result}")
print(f"Is 'c' in Sliced String? {'c' in result}")
print(f"Is 'P' in Sliced String? {'P' in result}")
print(f"Is 'y' in Sliced String? {'y' in result}")
