...
print()
message = "Hello"
print(message.center(2))
print(message.center(7))
...
print(e_text3.endswith(("to", "is", "python."), 0, 30))
...
#checks if all string is numberic or not
print()
in1 = "123"
in2 = "123abc"
in3 = "123 "
