...
def calculation(tax_percent, employee_name, rendered_hours, rate_per_hour, sss_contribution, philhealth_contribution, loans):
...
calculation(tax_percent, employee_name, rendered_hours, rate_per_hour, sss_contribution, philhealth_contribution, loans)
